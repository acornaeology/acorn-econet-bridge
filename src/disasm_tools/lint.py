"""Lint Econet Bridge ROM disassembly driver scripts and documentation.
...
def load_address_ranges(json_filepath):
    ...
    meta = data.get('meta', {})
    load_addr = meta.get('load_addr', 0xE000)
...
def lint(version_dirpath, version):
    ...
    if not json_filepath.exists():
        ...
        print("Run 'acorn-econet-bridge-disasm-tool disassemble' first.", file=sys.stderr)
        return 1
